...
public class Cliente
{
    ...
    public Cliente(int id, string cliCPF, string cliNome,
        string cliEndereco, string cliCidade, string cliBairro,
        string cliNumero, string cliTelefoneCelular, string cliTelefoneFixo)
    {
    ...
    public Cliente(string cliCPF, string cliNome, 
        string cliEndereco, string cliCidade, string cliBairro, 
        string cliNumero, string cliTelefoneCelular, string cliTelefoneFixo)
    {
        ValidateDomain(cliCPF, cliNome, cliEndereco, cliCidade, cliBairro, cliNumero, 
    ...
    public void Update(string cliCPF, string cliNome,
        string cliEndereco, string cliCidade, string cliBairro,
        string cliNumero, string cliTelefoneCelular, string cliTelefoneFixo)
    {
        ValidateDomain(cliCPF, cliNome, cliEndereco, cliCidade, cliBairro, cliNumero,
    ...
    public void ValidateDomain(string cliCPF, string cliNome,
        string cliEndereco, string cliCidade, string cliBairro,
        string cliNumero, string cliTelefoneCelular, string cliTelefoneFixo)
    {
